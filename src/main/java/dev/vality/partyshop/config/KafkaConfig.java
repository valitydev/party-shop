...
import dev.vality.partyshop.config.properties.KafkaConsumerProperties;
import dev.vality.partyshop.config.properties.KafkaSslProperties;
import dev.vality.partyshop.serializer.SinkEventDeserializer;
...
public class KafkaConfig {
    ...
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, MachineEvent>>
                kafkaListenerContainerFactory(KafkaSslProperties kafkaSslProperties) {
    ...
    private KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, MachineEvent>>
                createConcurrentFactory(ConsumerFactory<String, MachineEvent> consumerFactory, int threadsNumber) {
    ...
    public BatchErrorHandler kafkaErrorHandler() {
        var errorHandler = new SeekToCurrentWithSleepBatchErrorHandler();
